...
STAIR_TARGETS = {
    ...
    "specialist-soft-dynamics-rsi": {
        "task": "Mjlab-Stairs-Soft-Dynamics-RSI-Specialist-MicroDuck",
        "experiment": "microduck_stair_soft_dynamics_rsi_specialist",
        "iterations": 200,
    },
    "specialist-medium-dynamics-rsi": {
        "task": "Mjlab-Stairs-Medium-Dynamics-RSI-Specialist-MicroDuck",
    ...
    "specialist-lip-commitment-rsi": {
        "task": "Mjlab-Stairs-Lip-Commitment-RSI-Specialist-MicroDuck",
        "experiment": "microduck_stair_lip_commitment_rsi_specialist",
        "iterations": 75,
    },
    "specialist-lip-checkpoint-rsi": {
        "task": "Mjlab-Stairs-Lip-Checkpoint-RSI-Specialist-MicroDuck",
    ...
    "specialist-terminal-position-rsi": {
        "task": "Mjlab-Stairs-Terminal-Position-RSI-Specialist-MicroDuck",
    ...
    "specialist-forward-propagation-rsi": {
        "task": "Mjlab-Stairs-Forward-Propagation-RSI-Specialist-MicroDuck",
    ...
    "specialist-contact-stage-rsi": {
        "task": "Mjlab-Stairs-Contact-Stage-RSI-Specialist-MicroDuck",
        "experiment": "microduck_stair_contact_stage_rsi_specialist",
        "iterations": 75,
    },
    "specialist-stage15-reverse-rsi": {
        "task": "Mjlab-Stairs-Stage15-Reverse-RSI-Specialist-MicroDuck",
    ...
    "specialist-near-shell-reverse-rsi": {
        "task": "Mjlab-Stairs-Near-Shell-Reverse-RSI-Specialist-MicroDuck",
        "experiment": "microduck_stair_near_shell_reverse_rsi_specialist",
        "iterations": 75,
    },
    "specialist-stratified-shell-reverse-rsi": {
        "task": (
            "Mjlab-Stairs-Stratified-Shell-Reverse-RSI-Specialist-MicroDuck"
        ),
        "experiment": "microduck_stair_stratified_shell_reverse_rsi_specialist",
        "iterations": 75,
    },
