...
# Jump — crouch, push off, get both feet clear, land softly, return to stand.
# The GPU answer to the CPU lab's throughput-capped hop recipe (see
# microduck_jump_env_cfg.py header). Flat ground, walk model.
register_mjlab_task(
...
_BACKLASH_TASKS = (
    ...
    # Jump uses the walk model (flat ground, see the JUMP registration above),
    # so it gets the walk backlash robot — not allcollisions.
